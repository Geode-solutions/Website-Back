...
def sendBaseData():
    ...
    return flask.make_response({'viewable_1':viewable_1[6:], 'id1':"id1", 'viewable_2':viewable_2[6:], 'id2':"id2", 'viewable_3':viewable_3[6:], 'id3':"id3"}, 200)
...
def sendBRepStats():
    ...
    return flask.make_response({'viewable_file_name':viewable_file_name[6:], 'id':"explicit_brep", 'nb_corners':nb_corners, 'nb_lines':nb_lines, 'nb_surfaces':nb_surfaces, 'nb_blocks':nb_blocks }, 200)
