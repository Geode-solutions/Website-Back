...
app.register_blueprint(
    blueprint_file_converter.file_converter_routes, url_prefix=f"/{ID}/file_converter"
)
app.register_blueprint(
    blueprint_validity_checker.validity_checker_routes,
    url_prefix=f"/{ID}/validity_checker",
)
app.register_blueprint(
    blueprint_crs_converter.crs_converter_routes, url_prefix=f"/{ID}/crs_converter"
)
