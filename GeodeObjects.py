...
def ObjectsList():
    return {"BRep": {"input": [ opengeode.BRepInputFactory ], "output": [ opengeode.BRepOutputFactory ], "load": opengeode.load_brep, "save": opengeode.save_brep},
            ...
            "StructuralModel": {"input": [ opengeode_geosciences.StructuralModelInputFactory ], "output": [ opengeode_geosciences.StructuralModelOutputFactory ], "load": opengeode_geosciences.load_structural_model, "save": opengeode_geosciences.save_structural_model},
